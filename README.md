...
| Next.js / SSR | Practice | [Next.js 정리](cs/FE/Next.js/next.js.md), [App Router, Parallel Routes, Intercepting Routes](cs/FE/Next.js/app-router.md), [SSR Practice](https://github.com/sangyun-hwang/react-ssr-practice-without-nextjs) |
