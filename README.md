...
| React | Study Notes | [생태계, JSX, Virtual DOM, Fiber, 렌더링, 메모이제이션, useEffect와 Effect 생명주기](cs/FE/React.md), [Atomic Design](cs/FE/AtomicDesign.md) |
| Next.js / SSR | Practice | [Next.js 정리](cs/FE/Next.js/next.js.md), [14.2 이후 주요 변경사항](cs/FE/Next.js/version-updates.md), [App Router, Parallel Routes, Intercepting Routes](cs/FE/Next.js/app-router.md), [SSR Practice](https://github.com/sangyun-hwang/react-ssr-practice-without-nextjs) |
